...
function getExamsByBranch(id) {
  $.ajax({
    url: base_url + "ajax/examsMultiple",
    type: "POST",
    data: {
      branch_id: id,
    },
...
function fn_printElem(elem, html = false) {
  ...
  frameDoc.document.write(
    '<link rel="stylesheet" href="' + base_url + 'assets/css/ramom.css">'
  );
