        ...
        <div class="nano-content">
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    ...
                    get_permission('CBSC_report_card', 'is_view') ||
                        ...
                        || get_permission('tabulation_sheet', 'is_view')) { ?>
                            <li
                                ...
                                <ul class="nav nav-children">
                                    ...
                                    <?php } if(get_permission('CBSC_report_card', 'is_view')) { ?>
                                    <li class="<?php if ($sub_page == 'exam/CBSC_marksheet') echo 'nav-active';?>">
                                        <a href="<?=base_url('exam/CBSC_marksheet')?>">
                                            <span><?=translate('CBSC_report_card')?></span>
                                        </a>
                                    </li>
