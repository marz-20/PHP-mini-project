								...
								<div class="idcard_info">
									<table>
										<tbody>
											...
											<tr>
											<td width="80"><?=translate('birthday')?></td>
												<td width="8">:</td>
												<td>
													<?=empty($row->birthday) ? 'N/A' : $row->birthday;?>
												</td>
											</tr>
											<tr>
											<td width="80"><?=translate('mobile_no')?></td>
												<td width="8">:</td>
												<td>
													<?=empty($row->mobile_no) ? 'N/A' : $row->mobile_no;?>
												</td>
											</tr>
											<tr>
												<td width="80"><?=translate('current_address')?></td>
												<td width="8">:</td>
												<td>
													<?=empty($row->current_address) ? 'N/A' : $row->current_address;?>
												</td>
											</tr>
											<tr>
