				...
				<?php echo form_open('library/bookIssued', array('class' => 'form-horizontal form-bordered frm-submit')); ?>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
                        	...
                        	<select name="book_id[]" class="form-control" data-plugin-selectTwo multiple id='book_id' data-width="100%"
							data-plugin-options='{"placeholder": "<?=translate('select_multiple_subject')?>"}'>
								...
								?>
								<option value="<?=$book->id?>" <?=set_select('book_id[]', $book->id)?>><?=html_escape($book->title)?></option>
