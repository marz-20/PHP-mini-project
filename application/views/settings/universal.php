				...
				<div class="row">
					<div class="col-md-3">
						<div class="form-group">
							...
							<input type="file" name="logo_file" class="dropify" data-allowed-file-extensions="png" data-default-file="<?=base_url('uploads/app_image/printing-logo.png')?>" />
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<input type="file" name="report_card" class="dropify" data-allowed-file-extensions="png" data-default-file="<?=base_url('uploads/app_image/printing-logo.png')?>" />
						</div>
					</div>
				</div>
