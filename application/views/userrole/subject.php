	...
	<div class="panel-body">
		<table class="table table-bordered table-hover mb-none table-export">
			...
			<tbody>
				...
				$this->db->select('sa.subject_id,sa.student_id,sa.class_id,sa.teacher_id,sa.subject_type as stype,s.name as subject_name,s.subject_code,s.subject_type,s.subject_author,t.name as teacher_name');
				...
				foreach($subjectlist as $row):
        			...
        			if($row['stype'] == 'extra'){
        				...
        				if($stu['student_id'] != $row['student_id']){
                        	continue;
                        }
                    }
				...
				<tr>
					...
					<td><?php echo $row['subject_type'].$stype;?></td>
